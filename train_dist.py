# python main.py -a resnet18 /home/data/MINI-ImageNet/
#  python main.py -a resnet50 --dist-url 'tcp://127.0.0.1:18888' --dist-backend 'nccl'
#  --multiprocessing-distributed --world-size 1 --rank 0 /home/data/MINI-ImageNet/
...
parser = argparse.ArgumentParser(description='Train SimCLR in DDP mode')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_loader = torch.utils.data.DataLoader(
        train_data, batch_size=args.batch_size, drop_last=True, shuffle=(train_sampler is None),
        num_workers=0, pin_memory=True, sampler=train_sampler)

    memory_loader = torch.utils.data.DataLoader(
        memory_data, batch_size=args.batch_size, shuffle=(memory_sampler is None),
        num_workers=0, pin_memory=True, sampler=memory_sampler)

    test_loader = torch.utils.data.DataLoader(
        test_data, batch_size=args.batch_size, shuffle=(test_sampler is None),
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        test_acc_1, test_acc_5 = test(model, memory_loader, test_loader, epoch, args)
...
def train(net, data_loader, train_optimizer, epoch, args):
    ...
    for pos_1, pos_2, target in train_bar:  # target not used in self-supervised
        # print(args.gpu)
